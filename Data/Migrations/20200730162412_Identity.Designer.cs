...
namespace DucthTreat.Migrations
{
    ...
    [Migration("20200730162412_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DucthTreat.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2020, 7, 30, 16, 24, 11, 880, DateTimeKind.Utc).AddTicks(1507),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DucthTreat.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DucthTreat.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
